...
def get_scopus_info(SCOPUS_ID):
	url = ("http://api.elsevier.com/content/abstract/scopus_id/" + str(SCOPUS_ID) + "?field=authors,title,publicationName,volume,issueIdentifier,prism:pageRange,coverDate,article-number,doi,issn,citedby-count,prism:aggregationType")
	print("http://api.elsevier.com/content/abstract/scopus_id/38349047757?field=authors,title,citedby-count");
	resp = requests.get("http://api.elsevier.com/content/abstract/scopus_id/38349047757?field=authors,title,citedby-count",
	headers= {
...
def get_scopus_info(SCOPUS_ID):
	url = ("http://api.elsevier.com/content/abstract/scopus_id/" + str(SCOPUS_ID) + "?field=authors,title,citedby-count")
	print(url);
...
results = get_scopus_info(85072584446);
